<x-app-layout>
    <div class="mx-auto max-w-2xl">
        ...
        <div class="py-3 pl-3 border-b">
            <h1 class="font-bold mt-1 sm:text-slate-900 text-3xl">Agregar una Nota</h1>
        </div>
        ...
        <div class="grid grid-cols-1">
            <div class=" bg-white lg:p-16 sm:p-10 p-16 ">
                ...
                <div class="mb-6">
                    <div class="mb-6">
                        {!! Form::label('nota', 'Escribe una nota',['class' => 'font-bold block mb-2 text-sm font-medium']) !!}
                ...
                {!! Form::submit('Guardar Nota', ['class' => 'text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center']) !!}
